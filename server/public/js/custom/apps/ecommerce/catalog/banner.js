...
var KTAppEcommerceCategories = (function () {
    var t,
        e,
        n = () => {
            t.querySelectorAll('[data-kt-ecommerce-banner-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    t.preventDefault();
                    
                    const n = t.target.closest("tr"),
                        o = n.querySelector('[data-kt-ecommerce-banner-filter="banner_name"]').innerText,
                        el = n.querySelector('[data-kt-ecommerce-banner-filter="delete_row"]');
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_ecommerce_banner_table")) &&
                ((e = $(t).DataTable({
                    info: !1,
                    order: [],
                    pageLength: 10,
                ...
                document.querySelector('[data-kt-ecommerce-banner-filter="search"]').addEventListener("keyup", function (t) {
