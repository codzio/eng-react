...
var KTAppEcommerceCategories = (function () {
  var t,
    ...
    n = () => {
      t.querySelectorAll(
        '[data-kt-ecommerce-event-filter="delete_row"]'
      ).forEach((t) => {
        t.addEventListener("click", function (t) {
          ...
          const n = t.target.closest("tr"),
            o = n.querySelector(
              '[data-kt-ecommerce-event-filter="event_name"]'
            ).innerText,
            el = n.querySelector(
              '[data-kt-ecommerce-event-filter="delete_row"]'
            );
  ...
  return {
    init: function () {
      (t = document.querySelector("#kt_ecommerce_event_table")) &&
        ((e = $(t).DataTable({
          info: !1,
          order: [],
          pageLength: 10,
        ...
        document
          .querySelector('[data-kt-ecommerce-event-filter="search"]')
