...
var KTAppEcommerceCategories = (function () {
    var t,
        e,
        n = () => {
            t.querySelectorAll('[data-kt-ecommerce-faq-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    t.preventDefault();
                    
                    const n = t.target.closest("tr"),
                        o = n.querySelector('[data-kt-ecommerce-faq-filter="faq_name"]').innerText,
                        el = n.querySelector('[data-kt-ecommerce-faq-filter="delete_row"]');
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_ecommerce_faq_table")) &&
                ((e = $(t).DataTable({
                    info: !1,
                    order: [],
                    pageLength: 10,
                ...
                document.querySelector('[data-kt-ecommerce-faq-filter="search"]').addEventListener("keyup", function (t) {
