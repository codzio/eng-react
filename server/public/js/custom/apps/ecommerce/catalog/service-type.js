            ...
            t.querySelectorAll('[data-kt-ecommerce-service-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    ...
                    const n = t.target.closest("tr"),
                        ...
                        el = n.querySelector('[data-kt-ecommerce-service-filter="delete_row"]');
                    ...
                    Swal.fire({
                    	...
                    	$.ajax({
                        	...
                        	beforeSend: function() {
			                    //$("#kt_ecommerce_add_service_form .removeErr").html('');
			                    //$("#kt_ecommerce_add_service_form .indicator-label").hide();
			                    //$("#kt_ecommerce_add_service_form .indicator-progress").show();
			                },
			                success: function (succRes) {
			                    ...
			                    //$("#kt_ecommerce_add_service_form .indicator-label").show();
			                    //$("#kt_ecommerce_add_service_form .indicator-progress").hide();
			                },
