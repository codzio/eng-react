...
var KTAppEcommerceCategories = (function () {
  var t,
    ...
    n = () => {
      t.querySelectorAll(
        '[data-kt-ecommerce-annual-report-filter="delete_row"]'
      ).forEach((t) => {
        t.addEventListener("click", function (t) {
          ...
          const n = t.target.closest("tr"),
            o = n.querySelector(
              '[data-kt-ecommerce-annual-report-filter="product_name"]'
            ).innerText,
            el = n.querySelector(
              '[data-kt-ecommerce-annual-report-filter="delete_row"]'
            );
          ...
          Swal.fire({
            ...
            $.ajax({
              url: "/admin/annual-report/delete",
              type: "POST",
              dataType: "json",
              data: {
                id: el.dataset.id,
  ...
  return {
    init: function () {
      (t = document.querySelector("#kt_ecommerce_annual_report_table")) &&
        ((e = $(t).DataTable({
          info: !1,
          order: [],
          pageLength: 10,
        ...
        document
          .querySelector('[data-kt-ecommerce-annual-report-filter="search"]')
